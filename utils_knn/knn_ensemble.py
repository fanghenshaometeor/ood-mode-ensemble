...
parser.add_argument('--train_seed',type=int,help='random seeds',nargs='+')
...
parser.add_argument('--out_datasets',default=['SVHN','LSUN','iSUN','Texture','places365'])
args = parser.parse_args()

hyperparam = ''
for train_seed in args.train_seed:
    hyperparam = hyperparam + str(train_seed) + '-'
hyperparam += 'ens'
